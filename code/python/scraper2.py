...
def main():
	...
	year = "2024"
	team_names = ['GSW', 'HOU', 'LAC', 'LAL', 'PHO', 'SAC', 'DAL', 'DEN', 'MIN', 'OKC', 'POR', 'UTA', 'ATL', 'BOS', 'BKN', 'CHA', 'CHI', 'CLE', 'DET', 'IND', 'MIA', 'MIL', 'NYK', 'ORL', 'PHI', 'TOR', 'WAS']
	
	for team_abr in team_names:
		team_page_link = '/teams/'+team_abr+'/2024.html#all_roster'
